...
```bash
python3 scripts/fetch_index_docs.py --list-dataviews
```
...
Read [dataviews.py](scripts/dataviews.py) to prune deprecated aliases as Kibana data views replace them.
