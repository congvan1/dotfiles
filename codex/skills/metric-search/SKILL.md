...
3. Prefer the local helper:
   `python3 /Users/van/dotfiles/codex/skills/metric-search/scripts/query_prometheus.py`
...
- Pulsar metric registry:
  [pulsar_metrics.py](/Users/van/dotfiles/codex/skills/metric-search/references/pulsar_metrics.py)
- Query/catalog implementation:
  [catalog.py](/Users/van/dotfiles/codex/skills/metric-search/scripts/catalog.py)
  [query_prometheus.py](/Users/van/dotfiles/codex/skills/metric-search/scripts/query_prometheus.py)
