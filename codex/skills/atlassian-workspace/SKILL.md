...
3. Prefer local helper scripts for deterministic exports:
   - Confluence page export:
     - `python3 /Users/van/dotfiles/codex/skills/atlassian-workspace/scripts/fetch_page_to_docs.py <page_id>`
   - Jira issue fetch:
     - `python3 /Users/van/dotfiles/codex/skills/atlassian-workspace/scripts/fetch_jira_issue.py NEOSC-17607`
